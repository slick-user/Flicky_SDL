...
### HUD
  I vibe coded this ending portion using OpenCode Zen (Big Pickle), Might as well have OpenCode handle some placeholder menus. I have to rework the assets anyway and my experience with UIs and menu to game transition has me under the impression that there really is not anything here that it would do poorly anyway.
