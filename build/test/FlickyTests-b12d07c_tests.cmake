...
add_test( [==[World loads level from file]==] [==[D:/Programming/C++ Scripts/Flicky Remake/build/test/FlickyTests.exe]==] [==[World loads level from file]==]  )
set_tests_properties( [==[World loads level from file]==] PROPERTIES WORKING_DIRECTORY [==[D:/Programming/C++ Scripts/Flicky Remake/build/test]==])
...
set( FlickyTests_TESTS [==[Renderer Initializes Correctly]==] [==[Texture loads]==] [==[World loads level from file]==] [==[Game initializes]==])
